...
import ${packag}.service.I${name?cap_first}Service;
import ${packag}.mapper.${name?cap_first}Mapper;
import java.util.List;
import org.springframework.stereotype.Service;

@Service("${name}Service")
public class ${name?cap_first}ServiceImpl implements I${name?cap_first}Service{
