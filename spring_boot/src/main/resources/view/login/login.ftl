...
<div class="container demo-1">
    <div class="content">
        <div id="large-header" class="large-header">
            ...
            <div class="logo_box">
                <h3>欢迎你</h3>
                <form action="/login" id="login" name="f" method="post">
                    ...
                    <div class="mb2"><a class="act-but submit" href="javascript:document.getElementById('login').submit();" style="color: #FFFFFF">登录</a></div>
                </form>
            </div>
        </div>
    </div>
